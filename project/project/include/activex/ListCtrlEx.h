#ifndef _LIST_CTRL_EX_H_
#define _LIST_CTRL_EX_H_
...
{
	template <class T>
	class CListItemEx : public GUI::CWnd
	{
	public:
		CListItemEx();
		virtual ~CListItemEx();
	...
	template <class T>
	class CListCtrlEx : public GUI::CWnd
	{
		friend class CListItemEx<T>;
	public:
		CListCtrlEx();
		virtual ~CListCtrlEx();
	...
	private:
		...
		GUI::CListItemEx<T> *m_pListItemVir;	//虚拟项
	};
}
