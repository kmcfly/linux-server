...
#ifndef _WZD_NEW_NAT_SELECTDEV_DLG_H_
#define _WZD_NEW_NAT_SELECTDEV_DLG_H_
#include "Dialog.h"
...
class CWzdNewNatSelectDevDlg : public CWzdNatPageDlg
{
public:
	CWzdNewNatSelectDevDlg();
	~CWzdNewNatSelectDevDlg();
