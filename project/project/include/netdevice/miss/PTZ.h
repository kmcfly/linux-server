...
const char PTZ_PROTOCL_NAME [][64] = { "NULL","PELCOP", "PELCOD", "LILIN", "MINKING", "NEON", "STAR", "VIDO", "DSCP", "VISCA", "SAMSUNG", "RM110", "HY", "N-control"}; //N-control对应PL14协议
