...
{
	DD_VIDEO_FORMAT_NTSC	= 0x00,
	DD_VIDEO_FORMAT_PAL		= 0x01,
}DD_VIDEO_FORMAT;
...
{
	DD_VIDEO_SIZE_QCIF	= 0x0001,	//QCIF(176*144(PAL)/176*120(N))
	DD_VIDEO_SIZE_CIF	= 0x0002,	//CIF(352*288(PAL)/352*240(N))
	DD_VIDEO_SIZE_HD1	= 0x0004,	//HD1(704*288(PAL)/(704*240))
	DD_VIDEO_SIZE_D1	= 0x0008,	//D1(704*576(PAL)/704*480(N))

	DD_VIDEO_SIZE_QVGA	= 0x0010,	//QVGA(320*240)
	DD_VIDEO_SIZE_VGA	= 0x0020,	//VGA(640*480)
	//DD_VIDEO_SIZE_XVGA	= 0x0040,	//XVGA(1024*768)
	DD_VIDEO_SIZE_QQVGA	= 0x0080,	//QQVGA(160*120)

	DD_VIDEO_SIZE_960H	= 0x0100,	//960H(960*480)
	DD_VIDEO_SIZE_720P	= 0x0200,	//720P(1280*720)
	DD_VIDEO_SIZE_1080P	= 0x0400,	//1080P(1920*1080)
	//DD_VIDEO_SIZE_SVGA  = 0x0800,   //SVGA(800*600)

	DD_VIDEO_SIZE_SXGA	= 0x1000,   //SXGA(1280*1024)
	DD_VIDEO_SIZE_960P	= 0x2000,   //SXGA(1280*960)
	DD_VIDEO_SIZE_3M	= 0x8000,   //SXGA(2048 X 1536)

	DD_VIDEO_SIZE_16_9_3M = 0x4000,  //2304*1296
	DD_VIDEO_SIZE_4M      = 0x0800,  //2688*1520
	DD_VIDEO_SIZE_5M      = 0x0040,  //2592*1944
