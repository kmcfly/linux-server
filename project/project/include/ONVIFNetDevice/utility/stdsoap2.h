...
{ 
  ...
  SOAP_SOCKET (*fopen)(struct soap*, const char*, const char*, int, const char *);
...
SOAP_FMAC1 int SOAP_FMAC2 soap_connect_command(struct soap*, int, const char*, const char*, const char *pEther);
SOAP_FMAC1 int SOAP_FMAC2 soap_connect(struct soap*, const char*, const char*, const char * pEther = NULL);
