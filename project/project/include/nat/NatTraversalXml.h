...
public:
    ...
    void* GetCmd();
    ParseError GetError();
	NAT_TRAVERSAL_VERSION* GetVersion() {return &m_version;};
private:    
	...
	ParseError Parse_DeviceModifyReq(NAT_DEVICE_MODIFY_REQ *req);
	ParseError Parse_DeviceModifyReply(NAT_DEVICE_MODIFY_REPLY *reply);
...
private:
	...
	NAT_TRAVERSAL_VERSION m_version;
};
...
public:
	...
	~CNatTraversalXmlPacker();
	void Reset();
	void Reset(const NAT_TRAVERSAL_VERSION* version);
...
private:
	...
	bool Pack_DeviceModifyReq(NatXmlElement *cmdElement, NAT_DEVICE_MODIFY_REQ *req);
	bool Pack_DeviceModifyReply(NatXmlElement *cmdElement, NAT_DEVICE_MODIFY_REPLY *reply);
