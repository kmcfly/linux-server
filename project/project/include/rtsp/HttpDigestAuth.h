...
typedef int (*PGET_IPC_USED_INFO)(RTSP_GET_IPC_USED_INFO* pIpcInfo,void *pParam);
...
public:
	...
	bool GetBasicCredentials(const char* pUser, const char* pPass, char* pResult);

	void SetGetIpcInfoCallback(PGET_IPC_USED_INFO pCallback,void *pParam)
	{m_pGetIpcUsedInfo=pCallback;m_pGetIpcUsedParam=pParam;}
...
private:
	...
	void MD5Encrypt(void *pIn, int iLenIn, void *pOut, bool bUpper);
	bool ComputeDigestResponse(const char *pCmd, char *pResponseOut);
