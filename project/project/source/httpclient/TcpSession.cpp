...
#  define ReleaseHost(host)
#else
#  include "NetInterface.h"
#  define GetHostbyname CNetInterface::Instance()->GetHostByName
#  define ReleaseHost(host) CNetInterface::Instance()->ReleaseHost(host)
#endif// __ENVIRONMENT_WIN32__ else
