...
unsigned long CWzdUS02DSTDlg::CheckValue()
{
...
void CWzdUS02DSTDlg::InitCtrlInfo()
{
...
void CWzdUS02DSTDlg::SetWzdInfo(US02_WzdInfo* pWzdInfo)
{
	m_pWzdInfo = pWzdInfo;
}

void CWzdUS02DSTDlg::ShowWzdData(bool bRefresh)
{

}

void CWzdUS02DSTDlg::GetWzdData(bool bNext)
{
	if(CheckValue() != 0)
	{
		return;
...
void CWzdUS02DSTDlg::OnDestroy()
{

}

void CWzdUS02DSTDlg::OnPaint(PAINT_STATUS status)
{
	CWzdUS02PageDlg::OnPaint(status);
...
void CWzdUS02DSTDlg::SetPage(PAGE_ITEM item /*= PAGE_WEEK*/,bool bRefresh /*= true*/ )
{
	if( m_curPage != item )
	{
		m_curPage = item;
...
void CWzdUS02DSTDlg::CheckUI(bool bRefresh)
{
...
void CWzdUS02DSTDlg::RefreshView(bool bRefresh)
{
...
BEGIN_MSG_MAP(CWzdUS02DSTDlg, GUI::CDialog)
...
unsigned long CWzdUS02DSTDlg::OnClickList(unsigned long ctrlID, unsigned long keyID, unsigned long xPos, unsigned long yPos)
{
...
unsigned long CWzdUS02DSTDlg::OnClickRadio()
{
	CheckUI(true);
