...
CWzdNatDSTDateDlg::CWzdNatDSTDateDlg()
{
...
void CWzdNatDSTDateDlg::RefreshView(bool bRefresh)
{
...
void CWzdNatDSTDateDlg::OnInitial()
{
...
void CWzdNatDSTDateDlg::OnPaint(PAINT_STATUS status)
{

}

BEGIN_MSG_MAP(CWzdNatDSTDateDlg, GUI::CDialog)
	ON_MSG_EX(m_listCtrl.GetID(), KEY_VIRTUAL_MSG_DEFAULT_TAG, OnClickList)
END_MSG_MAP()
unsigned long CWzdNatDSTDateDlg::OnClickList(unsigned long ctrlID, unsigned long keyID, unsigned long xPos, unsigned long yPos)
{
