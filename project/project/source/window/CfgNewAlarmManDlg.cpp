...
CCfgNewAlarmManDlg::CCfgNewAlarmManDlg()
{
...
//////////////////////////////////////////////////////////////////////////
void CCfgNewAlarmManDlg::OnInitial()
{
...
*/
...
#endif
	{
		...
		m_stcVideoLoss.Create(CTRLID_STATIC, x + offset_text, y+size_btn, size_text, m_length[STATIC_HEIGHT], this, m_pStrTable->String(E_STR_ID_MENU_CFG_VIDEO_LOSS));
		m_btnVideoLoss.SetAlignText(GUI::ALIGN_TEXT_CENTER);
...
BEGIN_MSG_MAP(CCfgNewAlarmManDlg, GUI::CDialog)
#ifndef __DVR_ANCHOR__
...
unsigned long CCfgNewAlarmManDlg::OnSensor()
{
	m_sensorDlg.DoModal(this);
	return KEY_VIRTUAL_MSG_STOP;
}

/*unsigned long CCfgNewAlarmManDlg::OnMotion()
{
	m_motionManDlg.DoModal(this);
	return KEY_VIRTUAL_MSG_STOP;
}*/

unsigned long CCfgNewAlarmManDlg::OnVideoLoss()
{
	m_videoLossDlg.DoModal(this);
	return KEY_VIRTUAL_MSG_STOP;
}

unsigned long CCfgNewAlarmManDlg::OnOtherAlarm()
{
...
unsigned long CCfgNewAlarmManDlg::OnAlarmOut()
{
...
unsigned long CCfgNewAlarmManDlg::OnSpeedAlarm()
{
...
unsigned long CCfgNewAlarmManDlg::OnExit()
{
	EndDialog(DLG_ESC);
	return KEY_VIRTUAL_MSG_STOP;
}
