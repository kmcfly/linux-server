...
CWzdUS02DSTWeekDlg::CWzdUS02DSTWeekDlg()
{
...
void CWzdUS02DSTWeekDlg::RefreshView(bool bRefresh)
{
...
void CWzdUS02DSTWeekDlg::OnInitial()
{
...
void CWzdUS02DSTWeekDlg::OnPaint(PAINT_STATUS status)
{

}

BEGIN_MSG_MAP(CWzdUS02DSTWeekDlg, GUI::CDialog)
	ON_MSG_EX(m_listCtrl.GetID(), KEY_VIRTUAL_MSG_DEFAULT_TAG, OnClickList)
END_MSG_MAP()

unsigned long CWzdUS02DSTWeekDlg::OnClickList(unsigned long ctrlID, unsigned long keyID, unsigned long xPos, unsigned long yPos)
{
	assert(NULL != m_dst);
