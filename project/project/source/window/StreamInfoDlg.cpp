...
void CStreamInfoDlg::OnInitial()
{
	...
	m_streamInfoList.Create(GUI::CWnd::GetRandWndID(), x, y, width, height, this, 0, 0);
	m_streamInfoList.AddColumn("", width * 4 / 32 );
