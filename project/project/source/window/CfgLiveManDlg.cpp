...
CCfgLiveManDlg::CCfgLiveManDlg() : m_curPage( PAGE_LIVE ),
...
CCfgLiveManDlg::~CCfgLiveManDlg()
{

}

void CCfgLiveManDlg::OnInitial()
{
...
void CCfgLiveManDlg::GetItemList(CFGITEM_LIST& itemList) const
{
...
unsigned long CCfgLiveManDlg::OnApply()
{
	//Load default
...
#ifdef __DVR_BASIC__
unsigned long CCfgLiveManDlg::OnOK()
{
...
unsigned long CCfgLiveManDlg::OnCancel()
{
...
#endif
unsigned long CCfgLiveManDlg::CheckValue()
{
	CCfgDlg* pCfgDlg = GetPage(m_curPage);
	assert(pCfgDlg);
...
CCfgDlg* CCfgLiveManDlg::GetPage(PAGE_ITEM item)
{
...
void CCfgLiveManDlg::SetAnchorPage(PAGE_ITEM item)
{
	m_initAnchorPage = item;
}

BEGIN_MSG_MAP(CCfgLiveManDlg,CCfgDlg)
...
unsigned long CCfgLiveManDlg::OnPreCommand(unsigned long ctrlID, unsigned long keyID, unsigned long xPos, unsigned long yPos)
{
...
unsigned long CCfgLiveManDlg::OnClickLive()
{
...
unsigned long CCfgLiveManDlg::OnClickHost()
{
#ifdef __DVR_BASIC__
...
unsigned long CCfgLiveManDlg::OnClickSpot()
{
...
unsigned long CCfgLiveManDlg::OnClickCover()
{
	 if(0 !=  g_coverAreaCountLimit)
	 {
...
unsigned long CCfgLiveManDlg::OnClickROI()
{
...
unsigned long CCfgLiveManDlg::OnClickCamPara()
{
...
unsigned long CCfgLiveManDlg::OnVirtualEsc(unsigned long keyID, unsigned long xPos, unsigned long yPos)
{
	if((m_curPage == PAGE_HOST) && (0 != m_cfgLiveHostDlg.CheckDwell()))
	{
		GUI::CDialog::MessageBox( m_pStrTable->String(E_STR_ID_TIP_02_03), m_pStrTable->String(E_STR_ID_TITLE_ERROR), DEFAULT_BTN_OK | DEFAULT_ICON_ERROR);
...
CCfgLiveManAnchorDlg::CCfgLiveManAnchorDlg()
{
...
void CCfgLiveManAnchorDlg::OnInitial()
{
...
BEGIN_MSG_MAP(CCfgLiveManAnchorDlg, GUI::CDialog)
...
unsigned long CCfgLiveManAnchorDlg::OnAnchorLive()
{
	m_cfgLiveManDlg.SetAnchorPage(CCfgLiveManDlg::PAGE_LIVE);
	m_cfgLiveManDlg.DoModal(this, CENTER_POS, CENTER_POS, MAX_SCREEN_X, MAX_SCREEN_Y, false);

	return KEY_VIRTUAL_MSG_STOP;
}

unsigned long CCfgLiveManAnchorDlg::OnAnchorLiveHost()
{
#ifdef __DVR_BASIC__
	m_cfgLiveManDlg.SetAnchorPage(CCfgLiveManDlg::PAGE_HOST);
	m_cfgLiveManDlg.DoModal(this, CENTER_POS, CENTER_POS, MAX_SCREEN_X, MAX_SCREEN_Y, false);
#endif
	return KEY_VIRTUAL_MSG_STOP;
}

unsigned long CCfgLiveManAnchorDlg::OnAnchorLiveSpot()
{
	m_cfgLiveManDlg.SetAnchorPage(CCfgLiveManDlg::PAGE_SPOT);
	m_cfgLiveManDlg.DoModal(this, CENTER_POS, CENTER_POS, MAX_SCREEN_X, MAX_SCREEN_Y, false);

	return KEY_VIRTUAL_MSG_STOP;
}

unsigned long CCfgLiveManAnchorDlg::OnAnchorCover()
{
	if(0 !=  g_coverAreaCountLimit)
	{
		m_cfgLiveManDlg.SetAnchorPage(CCfgLiveManDlg::PAGE_COVER);
		m_cfgLiveManDlg.DoModal(this, CENTER_POS, CENTER_POS, MAX_SCREEN_X, MAX_SCREEN_Y, false);
	}
...
unsigned long CCfgLiveManAnchorDlg::OnAnchorROI()
{
	if (s_loginSuccessReply.productInfo.netVideoInputNum > 0){
		m_cfgLiveManDlg.SetAnchorPage(CCfgLiveManDlg::PAGE_ROI);
		m_cfgLiveManDlg.DoModal(this, CENTER_POS, CENTER_POS, MAX_SCREEN_X, MAX_SCREEN_Y, false);
	}
	return KEY_VIRTUAL_MSG_STOP;
}

unsigned long CCfgLiveManAnchorDlg::OnAnchorCamPara()
{
	if (s_loginSuccessReply.productInfo.netVideoInputNum > 0){
		m_cfgLiveManDlg.SetAnchorPage(CCfgLiveManDlg::PAGE_CAM_PARA);
		m_cfgLiveManDlg.DoModal(this, CENTER_POS, CENTER_POS, MAX_SCREEN_X, MAX_SCREEN_Y, false);
	}
	return KEY_VIRTUAL_MSG_STOP;
}

unsigned long CCfgLiveManAnchorDlg::OnExit()
{
	EndDialog(DLG_ESC);
	return KEY_VIRTUAL_MSG_STOP;
}
